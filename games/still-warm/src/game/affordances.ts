...
export const RECIPES: readonly Recipe[] = [
  ...
  {
    id: "cut_cloth",
    name: "Cut linen cloth into bandage",
    description:
      "Use a cutting tool on linen cloth to prepare a dressing bandage.",
    kind: "use",
    inputs: ["cloth"],
    output: "bandage",
    outputLocation: "tray",
...
export const SUPPORTED_USES: readonly SupportedUse[] = [
  ...
  },
  {
    item: "forceps",
    target: "door",
    description: "Seat the existing locking bars with forceps",
  },
  {
    item: "forceps",
    target: "scissors",
  ...
  },
  {
    item: "scalpel",
    target: "cloth",
    description: "Cut linen cloth into dressing bandage",
  },
  {
    item: "scalpel",
    target: "blanket",
  ...
  },
  {
    item: "scalpel",
    target: "door",
    description: "Seat the existing locking bars with scalpel",
  },
  {
    item: "scalpel",
    target: "creature",
  ...
  },
  {
    item: "mirror",
    target: "lamp",
    description: "Practice aligning the fixed examination lamp with a mirror",
  },
  {
    item: "mirror",
    target: "creature",
  ...
  },
  {
    item: "shard",
    target: "cloth",
    description: "Cut linen cloth into bandage",
  },
  {
    item: "shard",
    target: "blanket",
  ...
  },
  {
    item: "shard",
    target: "door",
    description: "Seat the existing locking bars with metal fragment",
  },
  {
    item: "shard",
    target: "creature",
  ...
  },
  {
    item: "release",
    target: "door",
    description: "Seat the existing locking bars with brace release",
  },
  {
    item: "release",
    target: "scissors",
  ...
  },
  {
    item: "bowl",
    target: "lamp",
    description: "Practice aligning the fixed examination lamp with a bowl",
  },
  {
    item: "bowl",
    target: "door",
    description: "Seat the existing locking bars with the bowl",
  },
  {
    item: "bowl",
    target: "pillow",
  ...
  // Candle
  {
    item: "candle",
    target: "wound",
    description: "Inspect the wound with a lit candle; rough contact burns",
  },
  {
    item: "candle",
    target: "patient",
  ...
  },
  {
    item: "candle",
    target: "door",
    description: "Inspect the door threshold with a lit candle",
  },
  {
    item: "candle",
    target: "fire",
    description: "Light the candle from the fire or spread the fire",
  },
  {
    item: "candle",
    target: "bowl",
    description: "Quench the candle with one water portion in the bowl",
  },
  {
    item: "candle",
    target: "pillow",
    description: "Practice holding a lit candle safely",
  },
  ...
  { item: "blade", target: "blanket", description: "Cut blanket into bandage" },
  {
    item: "blade",
    target: "door",
    description: "Seat the existing locking bars with razor blade",
  },
  {
    item: "blade",
    target: "creature",
...

  {
    ...
    target: "wound",
    description:
      "Blot exposed/extracted tissue or apply dressing to closed wound",
  },
  {
    item: "bandage",
    target: "patient",
