...
export default authoredRecipe('teleport-loop', 'Teleport loop', 'Arrival/departure loop with afterimage slice and stable anchor ring.', [
  ...
  { kind: 'particles', role: 'aura', opacity: 0.85, scale: 0.62, phase: 'teleport-loop-shimmer-pips', tuning: { sprite: 'twinkle', blend: 'additive', size: [0.32, 0.44, 0.24], colorOverride: '#66aaff', ramp: 'held', countScale: 0.34, speedScale: 0.55, speedJitter: 0.15, turbulenceScale: 0, motion: 'helix-trail', gravity: 0, spinScale: 0, death: 'erode' } },
], 2, 0.8)
