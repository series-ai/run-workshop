...
export default authoredRecipe('shadow-burst', 'Shadow burst', 'Particle-first shadow detonation adapted from the repo void-gather timing and Kenney CC0 slash/smoke cells: a five-finger slate claw fan, umbra residue, and a restrained rim.', [
  {
    ...
    tuning: {
      motion: 'shadow-claw', sprite: 'streak', proceduralShape: 'streak', blend: 'alpha', colorOverride: '#344b58', ramp: 'dark',
  ...
  },
  {
    ...
    tuning: {
      motion: 'drift-cloud', sprite: 'smoke-variants', proceduralShape: 'smoke', blend: 'alpha', colorOverride: '#263945', ramp: 'dark',
  ...
  },
  {
    ...
    tuning: {
      motion: 'impact-burst', sprite: 'spark', proceduralShape: 'glint', blend: 'alpha', colorOverride: '#9bb5c4', ramp: 'held',
