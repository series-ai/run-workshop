...
export default authoredRecipe('water-column', 'Water column', 'Particle-first geyser: a low wet splash, a narrow rising water body, and light crest foam.', [
  {
    ...
    tuning: {
      motion: 'shockwave-ground-burst', sprite: 'glow', proceduralShape: 'droplet', blend: 'additive', colorOverride: '#bdefff', ramp: 'held',
      lifecycle: 'water-column-particle-eruption', delay: 0, window: 0.18, lifeScale: 0.38,
      countScale: 0.85, speedScale: 2.8, speedJitter: 0.2, drag: 1.6, gravity: 0,
  ...
  },
  {
    ...
    tuning: {
      motion: 'column-rise', sprite: 'streak', proceduralShape: 'streak', blend: 'alpha', colorOverride: '#168fd1', ramp: 'held',
      lifecycle: 'water-column-particle-eruption', delay: 0.02, window: 0.68, lifeScale: 1.25,
      countScale: 1.1, speedScale: 9.2, speedJitter: 0.22, drag: 0.82, gravity: 0,
      spawnScale: 0.36, depthScale: 2.3, size: [0.15, 0.48, 0.14], spinScale: 0.12,
  ...
  },
  {
    ...
    tuning: {
      motion: 'drift-cloud', sprite: 'smoke', proceduralShape: 'smoke', blend: 'alpha', colorOverride: '#bdefff', ramp: 'held',
      lifecycle: 'water-column-particle-eruption', delay: 0.28, window: 0.32, lifeScale: 0.7,
      countScale: 0.35, speedScale: 0.35, speedJitter: 0.22, drag: 1.6, gravity: -0.08,
