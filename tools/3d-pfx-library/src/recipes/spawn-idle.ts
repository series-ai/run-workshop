...
export default authoredRecipe('spawn-idle', 'Spawn idle', 'Spawn point idle with ready mote field and origin glow.', [
  ...
  { kind: 'particles', role: 'aura', opacity: 0.8, scale: 0.62, phase: 'spawn-idle-ready-motes', tuning: { sprite: 'twinkle', blend: 'additive', size: [0.3, 0.4, 0.22], colorOverride: '#0077ff', ramp: 'held', countScale: 0.3, speedScale: 0.4, speedJitter: 0.2, turbulenceScale: 0.1, motion: 'ground-ring', gravity: 0, spinScale: 0, death: 'erode' } },
], 2, 0.68)
