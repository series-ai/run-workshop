...
export default authoredRecipe('dissolve', 'Object dissolve cloud', 'Erosion dissolve: body breaks cell-by-cell, edge motes rise off the front.', [
  ...
  { kind: 'particles', role: 'volume', opacity: 0.9, scale: 0.9, phase: 'dissolve-edge-motes', tuning: { motion: 'column-rise', sprite: 'glow', blend: 'additive', death: 'erode', delay: 0, window: 0.72, countScale: 0.55, speedScale: 0.8, speedJitter: 0.35, spawnScale: 0.7, size: [0.3, 0.45, 0.25], ramp: 'held', spinScale: 0, turbulenceScale: 0.2, gravity: 0.5, flicker: 0.8 } },
], 2, 1.0)
