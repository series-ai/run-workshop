...
export default authoredRecipe('target-loop', 'Target loop', 'Persistent target acquisition loop with reticle orbit and lock pips.', [
  ...
  { kind: 'particles', role: 'aura', opacity: 0.9, scale: 0.6, phase: 'target-loop-lock-pips', tuning: { sprite: 'sparkle', blend: 'additive', size: [0.3, 0.4, 0.24], colorOverride: '#66b3ff', ramp: 'held', countScale: 0.28, speedScale: 0.75, speedJitter: 0.1, turbulenceScale: 0, motion: 'orbit-ring', gravity: 0, spinScale: 0, death: 'erode' } },
