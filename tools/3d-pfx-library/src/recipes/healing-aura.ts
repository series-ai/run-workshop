...
export default authoredRecipe('healing-aura', 'Healing aura loop', 'Gentle recovery read with vertical motes and soft aura coverage.', [
  ...
  { kind: 'particles', role: 'aura', opacity: 0.72, scale: 0.9, phase: 'restoration-soft-rise', tuning: { motion: 'column-rise', sprite: 'glow', blend: 'additive', death: 'erode', colorOverride: '#b7ffe0', countScale: 0.45, spawnScale: 0.55, size: [0.1, 0.18, 0.14], speedScale: 0.55, spinScale: 0, turbulenceScale: 0.18 } },
