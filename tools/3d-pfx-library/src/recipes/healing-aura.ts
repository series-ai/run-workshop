...
export default authoredRecipe('healing-aura', 'Healing aura loop', 'Gentle recovery read with vertical motes and soft aura coverage.', [
  { kind: 'ring-field', role: 'aura', opacity: 0.95, scale: 1.05, phase: 'healing-aura-ground-boundary', tuning: { meshMotion: 'pulse', ringPurpose: 'reticle', colorOverride: '#2fd968' } },
  { kind: 'particles', role: 'aura', opacity: 0.72, scale: 0.9, phase: 'restoration-soft-rise', tuning: { motion: 'column-rise', sprite: 'glow', proceduralShape: 'soft', blend: 'additive', death: 'erode', colorOverride: '#b7ffe0', countScale: 0.45, spawnScale: 0.55, size: [0.1, 0.18, 0.14], speedScale: 0.55, spinScale: 0, turbulenceScale: 0.18 } },
