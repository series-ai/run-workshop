...
export default authoredRecipe('fireball', 'Comet fireball', 'Held-note projectile: hitbox-honest hot core is the brightest pixel, world-swept flame trail sells direction, glow card pushes the value range.', [
  {
    ...
    tuning: { lifecycle: 'held-projectile-ignition', motion: 'trail-stream', sprite: 'lick', proceduralShape: 'droplet', colorOverride: '#f04206', spawnOffset: [-0.3, 0, 0], spawnScale: 0.45, speedJitter: 0.22, size: [1.15, 0.9, 0.2], spinScale: 0.5, countScale: 0.9, speedScale: 17, drag: 0.3, stretch: 0, streamSpread: 0.32, lifeScale: 0.4, ramp: 'held', turbulenceScale: 0.35 },
  },
  ...
  { kind: 'core-sphere', role: 'body', opacity: 0.75, scale: 0.55, phase: 'heat-glow', tuning: { lifecycle: 'held-projectile-ignition', meshMotion: 'glow', colorOverride: '#e02f10' } },
  ...
  { kind: 'projectile-comet', role: 'body', opacity: 0.95, scale: 0.65, phase: 'hot-core', tuning: { lifecycle: 'held-projectile-ignition', meshMotion: 'travel', meshShader: 'fire-body', colorIndex: 0 } },
