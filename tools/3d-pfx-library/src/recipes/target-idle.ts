...
export default authoredRecipe('target-idle', 'Target idle', 'Targeting idle with reticle scan and lock pips.', [
  ...
  { kind: 'particles', role: 'aura', opacity: 0.9, scale: 0.58, phase: 'target-idle-lock-pips', tuning: { sprite: 'sparkle', blend: 'additive', size: [0.3, 0.4, 0.24], colorOverride: '#66b3ff', ramp: 'held', countScale: 0.2, speedScale: 0.7, speedJitter: 0.1, turbulenceScale: 0, motion: 'orbit-ring', gravity: 0, spinScale: 0, death: 'erode' } },
], 2, 0.68)
