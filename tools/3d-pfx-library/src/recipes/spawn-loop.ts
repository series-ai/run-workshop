...
export default authoredRecipe('spawn-loop', 'Spawn loop', 'Active spawn marker with materialization motes and arrival column.', [
  ...
  { kind: 'particles', role: 'aura', opacity: 0.85, scale: 0.62, phase: 'spawn-loop-materialize-motes', tuning: { sprite: 'twinkle', blend: 'additive', size: [0.32, 0.44, 0.24], colorOverride: '#66aaff', ramp: 'held', countScale: 0.34, speedScale: 0.5, speedJitter: 0.2, turbulenceScale: 0.05, motion: 'helix-trail', gravity: 0, spinScale: 0, death: 'erode' } },
