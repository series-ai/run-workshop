...
export default authoredRecipe('ui-loop', 'UI loop', 'Generic UI confirmation loop with restrained screen flash and interface particles.', [
  ...
  { kind: 'particles', role: 'screen', opacity: 0.8, scale: 0.52, phase: 'ui-loop-interface-pips', tuning: { sprite: 'twinkle', blend: 'additive', size: [0.26, 0.36, 0.2], colorOverride: '#9cc8ff', ramp: 'held', countScale: 0.32, speedScale: 0.45, speedJitter: 0.1, turbulenceScale: 0, motion: 'column-rise', gravity: 0, spinScale: 0, death: 'erode' } },
], 2, 0.8)
