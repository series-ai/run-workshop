...
export default authoredRecipe('teleport-idle', 'Teleport idle', 'Teleport arrival hum with anchor ring and shimmer pips.', [
  ...
  { kind: 'particles', role: 'aura', opacity: 0.85, scale: 0.6, phase: 'teleport-idle-shimmer-pips', tuning: { sprite: 'twinkle', blend: 'additive', size: [0.3, 0.42, 0.22], colorOverride: '#66aaff', ramp: 'held', countScale: 0.28, speedScale: 0.5, speedJitter: 0.15, turbulenceScale: 0, motion: 'helix-trail', gravity: 0, spinScale: 0, death: 'erode' } },
], 2, 0.68)
