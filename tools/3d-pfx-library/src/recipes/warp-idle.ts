...
export default authoredRecipe('warp-idle', 'Warp idle', 'Warp idle with lens bend and displaced space motes.', [
  ...
  { kind: 'particles', role: 'aura', opacity: 0.85, scale: 0.62, phase: 'warp-idle-displaced-motes', tuning: { sprite: 'twinkle', blend: 'additive', size: [0.34, 0.5, 0.2], colorOverride: '#7fb8f2', ramp: 'held', countScale: 0.32, speedScale: 0.6, speedJitter: 0.2, turbulenceScale: 0.15, motion: 'spherical-converge', gravity: 0, drag: 1.5, spinScale: 0, death: 'erode' } },
], 2, 0.81)
