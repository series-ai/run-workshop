...
export default authoredRecipe('warning-idle', 'Warning idle', 'Warning idle with alert breath and tick particles.', [
  ...
  { kind: 'particles', role: 'aura', opacity: 0.9, scale: 0.58, phase: 'warning-idle-tick-particles', tuning: { sprite: 'spark', blend: 'additive', size: [0.36, 0.5, 0.26], colorOverride: '#ff8a3d', ramp: 'hot', countScale: 0.3, speedScale: 0.6, speedJitter: 0.5, turbulenceScale: 0.1, motion: 'danger-pulse', gravity: 0, spinScale: 0, flicker: 1.8, death: 'erode' } },
], 2, 1.7)
