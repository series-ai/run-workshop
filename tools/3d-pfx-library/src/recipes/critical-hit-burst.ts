...
export default authoredRecipe('critical-hit-burst', 'Critical hit burst', 'Particle-first hero combat confirm: a white contact pop, a broad uneven victory fan, and a low red pressure handoff make the critical read larger without a mesh star or ring.', [
  {
    ...
    tuning: {
      motion: 'impact-burst', sprite: 'glow', proceduralShape: 'glint', blend: 'additive', colorOverride: '#fff9e8', ramp: 'pinned-hot',
      lifecycle: 'critical-hit-burst-particle-confirm', delay: 0, window: 0.12, lifeScale: 0.38,
      countScale: 0.2, speedScale: 3.4, speedJitter: 0.44, drag: 2.6, gravity: -0.1,
  ...
  },
  {
    ...
    tuning: {
      motion: 'radial-burst', sprite: 'streak', proceduralShape: 'streak', blend: 'alpha', colorOverride: '#ffd45e', ramp: 'pigment',
      lifecycle: 'critical-hit-burst-particle-confirm', delay: 0.035, window: 0.28, lifeScale: 0.66,
      countScale: 0.7, speedScale: 4.6, speedJitter: 0.5, drag: 0.86, gravity: -2.3,
  ...
  },
  {
    ...
    tuning: {
      motion: 'shockwave-ground-burst', sprite: 'puff', proceduralShape: 'smoke', blend: 'alpha', colorOverride: '#8f3428', ramp: 'dark',
      lifecycle: 'critical-hit-burst-particle-confirm', delay: 0.2, window: 0.4, lifeScale: 0.84,
      countScale: 0.32, speedScale: 2.3, speedJitter: 0.42, drag: 1.25, gravity: -0.55,
