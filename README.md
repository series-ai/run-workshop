...
- [Emberline Agent NPC](games/emberline-agent-npc/) — a React and Vite reference app for durable NPC chat. It includes streaming replies, game tools, approval and question flows, reload recovery, and safe multiple-tab session ownership. See [games/emberline-agent-npc/README.md](games/emberline-agent-npc/README.md).
